...
!                      sm update    22-01-2025 end 
      ...
      DO_3D( 0, 0, 0, 0, 1, jpk)
         trc3d(ji,jj,jkR,jp_grapoc) = zgrazing(ji,jj,jk) * 1.e+3 * rfact2r * tmask(ji,jj,jk) !  grazing of phyto by microzoo
         trc3d(ji,jj,jkR,jp_mico2)  = zgrazing(ji,jj,jk) * ( 1. -  epsher - unass ) &
